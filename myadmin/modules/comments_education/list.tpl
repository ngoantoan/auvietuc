...
<h2 class="ic-default">Danh sách bình luận khóa học</h2>
...
//        data['description'] = CKEDITOR.instances.detail.getData(va['description']);
    ...
    jQuery(document).ready(function () {
        var selectedId;
        jQuery("#list").jqGrid({
            url: 'index_ajax.php?q=comments_education&r=getJsonList&lang=' + $('#lang').val(),
            datatype: 'json',
            mtype: 'POST',
            styleUI: 'Bootstrap',
            ...
            viewrecords : false,
            toppager: true,
            editurl: "index_ajax.php?q=comments_education&r=update&lang=" + $('#lang').val(),
            subGridRowExpanded: function (subgrid_id, row_id) {
                ...
                jQuery("#" + subgrid_table_id).jqGrid({
                    url: "index_ajax.php?q=comments_education&r=getSubGridJsonList&id=" + row_id,
                    datatype: "json",
                    styleUI: 'Bootstrap',
                    ...
                    sortorder : "desc",
                    viewrecords: true,
                    editurl: "index_ajax.php?q=comments_education&r=updatesub&lang=" + $('#lang').val()
                });
    ...
    function reload() {
        var value =$('#lang').val();
                jQuery("#list").jqGrid('setGridParam', {
            url: "index_ajax.php?q=comments_education&r=getJsonList&lang=" + value,
            editurl: "index_ajax.php?q=comments_education&r=update&lang=" + value
        }).trigger("reloadGrid");
    }
</script>
