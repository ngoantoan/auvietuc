...
<h2 class="ic-default">Danh sách ảnh góc học viên</h2>
...
//        data['description'] = CKEDITOR.instances.detail.getData(va['description']);
        ...
        jQuery("#list").jqGrid({
            ...
            subGridRowExpanded: function (subgrid_id, row_id) {
                ...
                jQuery("#" + subgrid_table_id).jqGrid({
                    url: "index_ajax.php?q=student&r=getSubGridJsonList&id_category=" + row_id,
                    datatype: "json",
                    styleUI: 'Bootstrap',
                    colNames: ['ID', 'Tiêu đề', 'Hình ảnh', 'Hiển thị', 'Ngày', 'Ảnh'],
                    colModel: [{
                        name: 'id',
                        index: 'id',
                        key: true,
    ...
    function reload() {
        var value =$('#lang').val();
                jQuery("#list").jqGrid('setGridParam', {
            url: "index_ajax.php?q=student&r=getJsonList&lang=" + value,
            editurl: "index_ajax.php?q=student&r=update&lang=" + value
        }).trigger("reloadGrid");
    }
</script>
